...
\begin{document}
  ...
  \begin{aligncustom}
    \textrm{KL}(p||q) &= -\int {p(\textbf{x}) \left( \ln \left(  \frac{\sigma}{s} \right) + \frac{-(x-m)^2}{2s^2}+\frac{(x-\mu)^2}{2 \sigma^2} \right) dx } \textrm{.} \\~\\
    &= -\int {\frac{1}{\sqrt{2 \pi \sigma^2}} e^{\frac{-(x-\mu)^2}{2 \sigma^2}} \left( \ln \left(  \frac{\sigma}{s} \right) + \frac{-(x-m)^2}{2s^2}+\frac{(x-\mu)^2}{2 \sigma^2} \right) dx } \textrm{.}
  \end{aligncustom}
