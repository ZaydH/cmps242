...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Trump Character RNN Training Architecture}\label{fig:trainingRnnArchitecture}
\end{figure}
...
% our training process
\section{Text Generation Architecture}\label{sec:generationRnnArchitecture}
