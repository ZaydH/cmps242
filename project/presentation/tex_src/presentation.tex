		...
		\begin{itemize}
			\onslide<+->{
				...
				\begin{itemize}
					...
					\onslide<+->{\item Example: \textit{``the people from the people from the people from...''}}
				\end{itemize}
			}
			...
			\onslide<+->{
				\item \textbf{Mixing }\textit{Greedily choose each character at the beginning of a word, then complete the word with random choices.}
				
				\begin{itemize}
					\onslide<+->{\item Breaks loops at the word level but doesn't shatter overall sentence structure.}
				\end{itemize}
