		...
		\begin{itemize}
			\onslide<+->{
				...
				\begin{itemize}
					...
					\onslide<+->{\item \textit{``\textcolor{red}{The media is so dishonest.} They want to stop the people of the world. I want to stop the people of the world. I want to stop the people of the world. I want...''}}
				\end{itemize}
			}
			...
			\onslide<+->{
				...
				\begin{itemize}
					...
					\onslide<+->{\item \textit{``\textcolor{red}{The media is so dishonest.} And thank you. I trace it. We can change it. We don’t worts out.''}}
				\end{itemize}
			}
			...
			\onslide<+->{
				...
				\begin{itemize}
					...
					\onslide<+->{\item \textit{``\textcolor{red}{The media is so dishonest.} And they don’t know where you see it. I'm going to bring back the world.''}}
				\end{itemize}
			}
